<footer class="custom-footer">
    <div class="container">
      <div class="footer-content">
        ...
        <div class="footer-text">
          <h5 class="footer-title">DIAMANTINA CAR</h5>
          <p class="footer-description">
            DIAMANTINA CAR offers you the best car rental deals in Marrakech.
          </p>
          ...
          <nav class="footer-nav">
            ...
            <a href="/terms">General Rental Conditions</a>
            <a href="/terms">Payment Terms</a>
          </nav>

          <div class="footer-contact">
            <p><i class="fas fa-map-marker-alt"></i> Angle Avenue 11 Janvier & Rue, Bd Prince Moulay Abdellah, Marrakech 40000</p>
            <p><i class="fas fa-phone"></i> 06.61.06.03.62 | 06.60.56.57.30</p>
            <p>
              <i class="fas fa-envelope"></i>
              <a href="mailto:contact@diamantinacar.com">contact@diamantinacar.com</a>
            </p>
          </div>
  ...
  <script>
    ...
    document.getElementById('footer-year').innerHTML = `&copy; ${currentYear} DIAMANTINA CAR. All rights reserved.`;
  </script>
