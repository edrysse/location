      ...
      <div class="bg-white p-4 rounded-lg shadow mb-6">
        <form method="GET" action="{{ route('cars.index') }}">
          <div class="flex flex-nowrap items-center gap-4 overflow-x-auto">
            ...
            <!-- Location (اسم الحقل موحّد إلى pickup_location) -->
            <div class="flex-shrink-0 min-w-[150px]">
              <label for="pickup_location" class="block text-gray-700 font-medium mb-1">Location</label>
              <select name="pickup_location" id="pickup_location" class="border rounded-md px-3 py-2 w-full">
                <option value="">All</option>
