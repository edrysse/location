...
<body class="bg-gray-100">
      ...
      <table class="min-w-full text-sm text-left text-gray-700">
        ...
        <tbody>
          ...
          <tr class="border-b hover:bg-gray-50 transition duration-300">
            ...
            <!-- Image (تم تكبيرها ووضعها في الوسط) -->
            <td class="px-4 py-4">
              @if($car->image)
                <img
            ...
            <!-- Price 2-5 Days -->
            <td class="px-4 py-4">
              ${{ number_format($car->price_2_5_days, 2) }}
            </td>
            <!-- Price 6-10 Days -->
            <td class="px-4 py-4">
              ${{ number_format($car->price_6_10_days, 2) }}
            </td>
            <!-- Price 20 Days -->
            <td class="px-4 py-4">
              ${{ number_format($car->price_20_days, 2) }}
            </td>
            <!-- Franchise Price -->
            <td class="px-4 py-4">
            ...
            <!-- Actions (زرّي Edit و Delete في نفس السطر) -->
  ...
  <!-- مودال عرض صورة السيارة (الإعدادات السابقة) -->
  <div id="imageModal" class="fixed inset-50 bg-gray-900 bg-opacity-50 hidden items-center justify-center z-50">
  ...
  <!-- مودال عرض تفاصيل الفصل (تصميم احترافي لتطبيق حجز السيارات) -->
    ...
    <div class="absolute inset-0 bg-black bg-opacity-60 flex items-center justify-center p-4" onclick="closeSeasonModal()">
      <div class="bg-white rounded-lg shadow-xl w-full max-w-md" onclick="event.stopPropagation()">
        ...
        <div class="px-6 py-4 flex justify-end">
          <button onclick="closeSeasonModal()" class="bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600 transition duration-300">Close</button>
        </div>
      </div>
    </div>
  </div>
  ...
  <!-- Scripts -->
  <script>
    // مودال عرض الصورة (الإعدادات السابقة)
